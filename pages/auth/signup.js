    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-stone-50 to-slate-100 flex items-center justify-center p-6">
      ...
      >
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl font-light text-slate-800 mb-2">Create Account</h1>
          <p className="text-slate-600 font-light">Join us to create beautiful greetings</p>
        </div>
        ...
        <div className="bg-white/60 backdrop-blur-sm rounded-2xl p-8 border border-stone-200/50 shadow-lg">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <label className="block text-slate-700 font-light mb-2">Name</label>
              <input
                type="text"
                required
                value={formData.name}
